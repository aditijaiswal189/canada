          ...
          <div className="flex-1 flex flex-col gap-2">
            ...
            <div className="flex flex-col justify-start gap-6">
              ...
              <p className="text-sm text-black/60 text-left">
                ...
                destination for tourists worldwide. If you&aposre considering a
              ...
              <p className="text-sm text-black/60 text-left">
                ...
                information. It&aposs crucial to ensure accuracy in the
        ...
        <CTADefault
          ...
          subtitle={
            <p className="text-4xl text-white/90">
              Let&aposs GreenTech Resources Worldwide Canada <br />
              assist you!
            </p>
          }
          image={"/service.jpg"}
